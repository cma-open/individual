...
from individual.common.common import StatusException, check_install_status, clean_directory
...
@patch("individual.common.common.find_spec")  # Note the source!
def test_check_install_status_full_install(mock_find_spec, capsys):
    ...
    full_spec = ModuleSpec(
        name="individual",
        loader=None,
        origin="/example/lib/python/site-packages/individual/__init__.py",
    )
...
def test_check_install_status_editable(mock_find_spec, capsys):
    ...
    editable_spec = ModuleSpec(
        name="simple",
        loader=None,
        origin="/example/user/path/repos/individual/individual/src/individual/__init__.py",
    )
...
def test_check_install_status_bad_path(mock_find_spec):
    ...
    bad_spec = ModuleSpec(
        name="individual",
        loader=None,
        origin="/example/user/path/repos/individual/individual/simple/__init__.py",
    )
    # Set the mocked function return value
